...
from experiment.continum import continuum
...
def get_cifar_data(dataset_name, batch_size, n_workers, **kwargs):
    ...
    if dataset_name == "cifar10":
        task_num = 5
        class_num = 10
        data_dir = '/data/ckpt/yangxiaochen/MOSE/data/binary_cifar10_5/'
    elif dataset_name == "cifar100":
        task_num = 10
        class_num = 100
        data_dir = '/data/ckpt/yangxiaochen/MOSE/data/binary_cifar100_10/'
    class_per_task = class_num // task_num

    if not os.path.isdir(data_dir):
        os.makedirs(data_dir)
        dataset_path = '/data/ckpt/yangxiaochen/MOSE/data/'
...
def get_tinyimagenet(batch_size, n_workers, n_tasks=10):
    data = {}
    size = [3, 64, 64]
    task_num = n_tasks
    class_num = 200
    ...
    base_path = '/data/dataset/liqiwei/OCL/data/TINYIMG/'
    data_dir = f'/data/ckpt/yangxiaochen/PPE++/data/tiny/binary_tiny200_{task_num}'
...
def get_miniimagenet( batch_size, n_workers,n_tasks,args=None):
    dir = '/root/yxc/'
...
DATASETS = {
    ...
    'mini_imagenet': get_miniimagenet
}
